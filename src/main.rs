...
fn modifiers() -> String {
    let mut modifiers = "pub struct Modifiers {\n".to_string();
    ...
    modifiers.push_str("pub static MODIFIERS: Modifiers = Modifiers {\n");
    for mod_name in MODIFIERS {
        let field = class_to_rust_var(mod_name);
